...
namespace Stock_Exchange_Portfolio.ViewModels
{
    public class MainViewModel : INotifyPropertyChanged
    {
        ...
        public void LoadData()
        {
            ...
            items.Add(new ChartItemViewModel { Month = "January", Value = 47 });
            items.Add(new ChartItemViewModel { Month = "February", Value = 32 });
            items.Add(new ChartItemViewModel { Month = "Marth", Value = 41 });
            items.Add(new ChartItemViewModel { Month = "April", Value = 55 });
            items.Add(new ChartItemViewModel { Month = "May", Value = 38 });
            items.Add(new ChartItemViewModel { Month = "June", Value = 52 });
